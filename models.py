...
class Product(db.Model):
    ...
    stock_receipts = db.relationship('StockReceipt', backref='product', lazy=True)
    stock_history = db.relationship('Stock', backref='product', lazy=True)
...
class StockReceipt(db.Model):
    ...
    # 🔥 IMPORTANT RELATIONSHIP (FIXES YOUR ERROR)
